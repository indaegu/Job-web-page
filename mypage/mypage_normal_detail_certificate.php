...
<head>
  ...
  <form method="post" action="mypage_normal_detail_certificate_ok.php?아이디=<?php echo $board['아이디']?>">

      <p>자격증 이름</p>
      <p style="width:400px;">자격증이름 등록번호 취득날짜</p>
      <input type="text" name="name_cert"><input type="text" name="num_cert"><input type="date" name="getdate_cert"><br>
