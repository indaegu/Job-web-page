...
<form method="post" action="mypage_normal_detail_language_ok.php?아이디=<?php echo $board['아이디']?>">

        <p>어학</p>
        <p style="width:400px;">어학이름 등록번호 어학점수 취득날짜</p>
        <input type="text" name="name_lang"><input type="text" name="num_lang">
        <input type="text" name="score_lang"><input type="date" name="getdate_lang"><br>
